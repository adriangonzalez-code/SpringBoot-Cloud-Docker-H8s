...
import com.driagon.microservices.app.services.IOrderService;
...
public class OrderController {
    ...
    public ResponseEntity<Long> placeOrder(@RequestBody OrderRequest request) {
        long orderId = this.service.placeOrder(request);
    ...
    public ResponseEntity<OrderResponse> getOrderDetails(@PathVariable long orderId) {
        OrderResponse orderResponse = this.service.getOrderDetails(orderId);
